...
Ответ: /query_test --name 'общий анализ крови' --start 2022-08-01 --end 2022-08-31 
...
Для результатов анализов допустимые значения для поля "document_type" только такие: ["анализ крови", "анализ мочи", "копрограмма", "бактериология", "аллергены", "онкомаркеры", "другое"]
Для результатов исследования допустимые значения для поля "document_type" только такие: ["узи", "томография", "рентгенография", "эхокардиография", "другое"]
Меняй на них все похожие формулировки, например, "Общий анализ крови" в "анализ крови", "Клинический анализ мочи" в "анализ мочи", "мрт" в "томография", "экг" в "эхокардиография".
